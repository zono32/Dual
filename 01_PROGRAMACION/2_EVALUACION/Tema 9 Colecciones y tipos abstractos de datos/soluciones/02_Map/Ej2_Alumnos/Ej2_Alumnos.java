...
/**
 *Programa que almacene y gestione los Nºexpediente y alumnos de la clase (de cada alumno se almacenará DNI, nombre, edad y dirección).
...
public class Ej2_Alumnos {
    ...
    private void rellenarHashMap() {
        ...
        alumnos.put(2, new Alumno("2222222B", "Pepe", 22, "Ourense"));
    ...
    private void existeAlumno(int nexp) {
        if (!alumnos.containsKey(nexp)) {
            ...
            System.out.println("Alumno: " + alumnos.get(nexp).toString());
        }
    }
