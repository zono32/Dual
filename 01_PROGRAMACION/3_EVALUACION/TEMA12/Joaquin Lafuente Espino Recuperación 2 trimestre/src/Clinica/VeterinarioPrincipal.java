...
public class VeterinarioPrincipal {
    ...
    private static Veterinario altaVeterinario() {
        ...
        try {
            ...
            String dni = sc.next();
            if( dni.length() != 9){
                throw new ExcepMalDni("ERROR: La edad no puede ser un número negativo");
            }
            ...
            vet = new Veterinario(dni, nom, edad, direc, vet.getSueldoMensual(), vet.getEspecialidad(),vet.getFechaContratacion(),rellenarRegistroMascotas());
    ...
    private static HashMap<Integer, Mascota> rellenarRegistroMascotas() {
        ...
        masc.put(0, new Mascota("Mia", "Perro",  LocalDate.parse("26/02/2010"), LocalDate.parse("26/02/2014")));
