    ...
    <div class="container-fluid">
        ...
        <?php endif;
            ...
            function findAllPublishers(): array
            {
                ...
                $consulta = "SELECT *FROM publishers ORDER BY name";
                $pdostmt = $conProyecto->prepare($consulta);
                $pdostmt->execute();
            ...
            function findAllAuthors(): array
            {
                ...
                $consulta = "SELECT author_id, TRIM(CONCAT_WS(', ', last_name, first_name, middle_name)) as name, author_id              
                FROM authors ORDER BY last_name ASC";
                $pdostmt_authors = $conProyecto->prepare($consulta);
