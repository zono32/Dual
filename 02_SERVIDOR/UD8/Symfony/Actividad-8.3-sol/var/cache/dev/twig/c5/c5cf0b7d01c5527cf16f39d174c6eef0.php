...
class __TwigTemplate_f744752d6f9816e03918b99bef8b23c9 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    <h1>Hello ";
        ...
        echo "! ✅</h1>
    <p>Se ha creado la nota ";
        // line 13
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["nota"]) || array_key_exists("nota", $context) ? $context["nota"] : (function () { throw new RuntimeError('Variable "nota" does not exist.', 13, $this->source); })()), "id", [], "any", false, false, false, 13), "html", null, true);
        echo "</p>
...
{% block title %}Hello NotaController!{% endblock %}
...
<div class=\"example-wrapper\">
    ...
    <p>Se ha creado la nota {{nota.id}}</p>
    
</div>
{% endblock %}
", "nota/index.html.twig", "C:\\Users\\a21joaquinle\\Desktop\\workspace\\DUAL\\02_SERVIDOR\\UD8\\Symfony\\Actividad-8.3-sol\\templates\\nota\\index.html.twig");
    }
}
