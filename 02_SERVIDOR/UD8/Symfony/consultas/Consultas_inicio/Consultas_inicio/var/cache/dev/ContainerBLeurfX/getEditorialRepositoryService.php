 ...
 */
class getEditorialRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EditorialRepository' shared autowired service.
     *
     * @return \App\Repository\EditorialRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EditorialRepository.php';

        return $container->privates['App\\Repository\\EditorialRepository'] = new \App\Repository\EditorialRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
