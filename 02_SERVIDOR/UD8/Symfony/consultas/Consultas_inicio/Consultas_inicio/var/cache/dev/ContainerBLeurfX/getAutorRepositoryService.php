 ...
 */
class getAutorRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AutorRepository.php';

        return $container->privates['App\\Repository\\AutorRepository'] = new \App\Repository\AutorRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
